...
async def climats_get_select_all(is_need_pictures: bool = False):
    """Описание: получение данных обо всех климатах."""
    conn = get_db_connection()
    x = get_climats(conn, is_need_pictures)
    return Response(
...
async def climats_insert(climat_name: str, climat_description: str | None = None, climat_picture_id: int | None = None,
    ...
    if climat_picture_id is not None and climat_picture_id < 0:
